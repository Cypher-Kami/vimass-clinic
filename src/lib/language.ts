...
export const translations = {
  es: {
    ...
    common: {
      ...
      aftercare: 'Cuidados',
      aftercareDo: 'Recomendaciones',
      aftercareDont: 'Evitar',
      aftercareDo1: 'Hidratación y fotoprotección diaria.',
      aftercareDo2: 'Evitar calor intenso 24–48h.',
      aftercareDo3: 'Seguir pauta cosmética indicada.',
      aftercareDont1: 'Exposición solar directa las primeras 48–72h.',
      aftercareDont2: 'Sauna/baño turco y ejercicio intenso 24h.',
      aftercareDont3: 'Manipular la zona tratada sin indicación.',
      medDisclaimer: 'La información mostrada es general y no sustituye la valoración médica. Los resultados pueden variar según cada paciente.',
      related: 'También te puede interesar',
      medicalAssessment: 'Valoración médica',
      bookingCopy: 'Reserva una consulta y diseñaremos tu plan personalizado.',
      share: 'Compartir',
      shareNative: 'Nativo',
      copyLink: 'Copiar enlace',
      lastReviewed: 'Última revisión',
      procedureDefault: 'Valoración médica, diseño del plan y aplicación del tratamiento según indicación.',
      navigation: {
        previous: 'Anterior',
        next: 'Siguiente',
  ...
  en: {
    ...
    common: {
      ...
      procedure: 'Procedure',
      aftercare: 'Aftercare',
      aftercareDo: 'Recommendations',
      aftercareDont: 'Avoid',
      aftercareDo1: 'Daily hydration and photoprotection.',
      aftercareDo2: 'Avoid intense heat 24–48h.',
      aftercareDo3: 'Follow indicated cosmetic routine.',
      aftercareDont1: 'Direct sun exposure first 48–72h.',
      aftercareDont2: 'Sauna/Turkish bath and intense exercise 24h.',
      aftercareDont3: 'Manipulate treated area without indication.',
      medDisclaimer: 'The information shown is general and does not replace medical evaluation. Results may vary according to each patient.',
      related: 'You might also be interested in',
      medicalAssessment: 'Medical assessment',
      bookingCopy: 'Book a consultation and we will design your personalized plan.',
      share: 'Share',
      shareNative: 'Native',
      copyLink: 'Copy link',
      lastReviewed: 'Last reviewed',
      procedureDefault: 'Medical evaluation, plan design and treatment application according to indication.',
      navigation: {
        previous: 'Previous',
        next: 'Next',
