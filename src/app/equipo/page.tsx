        ...
        <div className="container pt-28 pb-12">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl">
              Experiencia, innovación y dedicación al servicio de tu bienestar integral
            </p>
          </div>
        </div>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="font-title text-3xl md:text-4xl">Dra. Celina Suárez</h2>
                      <p className="text-accent font-medium text-lg">Especialista en Medicina Interna</p>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  <p className="text-lg leading-relaxed">
                    <strong className="text-foreground">Más de 20 años</strong> dedicados a revolucionar la medicina preventiva 
                    y regenerativa, con un enfoque único que combina evidencia científica y atención personalizada.
                  </p>
                  ...
                  <div className="bg-gradient-to-r from-accent/5 to-secondary/5 p-6 rounded-2xl border border-accent/20 hover:border-accent/40 transition-all duration-300">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="font-semibold text-foreground">Experiencia Internacional</h3>
                    </div>
                    <div className="grid gap-3">
                      {[
                        { name: "SHA Wellness Clinic", location: "Alicante", icon: Sparkles },
                        { name: "Centro Médico Teknon", location: "Barcelona", icon: Microscope },
                        { name: "Clínica Planas", location: "Barcelona", icon: Heart },
                        { name: "Consulta privada", location: "Passeig de Gràcia", icon: MapPin }
                      ].map((center, index) => (
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="bg-background border border-border p-5 rounded-xl hover:shadow-lg transition-all duration-300 group">
                      ...
                      <ul className="space-y-2">
                        {["Medicina Funcional", "Protocolos de Longevidad", "Medicina Integrativa", "Biorregulación Terapéutica"].map((item, index) => (
                    ...
                    <div className="bg-background border border-border p-5 rounded-xl hover:shadow-lg transition-all duration-300 group">
                      ...
                      <ul className="space-y-2">
                        {["+3,500 pacientes atendidos", "Equipos multidisciplinarios", "Tecnologías innovadoras", "Abordaje holístico"].map((item, index) => (
                          <li key={index} className="text-sm text-muted-foreground flex items-center gap-2">
                            <div className="w-1.5 h-1.5 bg-accent rounded-full"></div>
                            {item}
                          </li>
                  ...
                  <div className="relative">
                    ...
                    <blockquote className="pl-6 py-4 bg-accent/5 rounded-r-xl border border-accent/20">
                      <p className="italic text-foreground font-medium mb-2">
                        "Mi misión es ir más allá de tratar síntomas: busco optimizar la salud integral de cada persona, 
                        combinando medicina de precisión con un toque humano excepcional."
                      </p>
                      <cite className="text-accent text-sm font-medium">— Dra. Celina Suárez</cite>
                    </blockquote>
                  </div>
                </div>
              </div>
          ...
          <Section>
            <div className="bg-gradient-to-r from-secondary/10 to-accent/10 rounded-3xl p-8 md:p-12">
              <div className="text-center mb-8">
                <h3 className="font-title text-3xl mb-4">¿Listo para comenzar tu transformación?</h3>
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Agenda una consulta personalizada y descubre cómo podemos ayudarte a alcanzar tu máximo potencial de bienestar.
                </p>
              </div>
